...
function encodeToRot13(str) {
  ...
  const nlp = 'nopqrstuvwxyzabcdefghijklmNOPQRSTUVWXYZABCDEFGHIJKLM';
  return str.replace(/[a-z]/gi, (c) => nlp[alp.indexOf(c)]);
}
